<template>
  <div class='navbar-container'>
    <nav class="navbar">
      <a href="/src/13.相关页面/vue-page/public" class="navbar-logo">
        <img src="@/assets/logo.png" width="50" height="50" style="margin-right: 10px;border-radius: 50px" alt="home">
        <h1>Chat</h1>
      </a>
      <!-- 导航栏 -->
...
.navbar .navbar-nav .navbar-nav-dropdown {
  display: flex;
}

.navbar .navbar-nav .navbar-nav-dropdown .navbar-nav-message {
  font-size: 18px;
  display: flex;
  align-items: center;
}

.navbar .navbar-nav .navbar-nav-dropdown .navbar-nav-message span {
  margin-right: 10px;
  font-size: 14px;
}

.navbar .navbar-nav .navbar-nav-dropdown .navbar-nav-message .user-avatar img {
  margin-right: 20px;
