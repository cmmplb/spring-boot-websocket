<template>
  ...
  <div class="aside-container">
    <ul class="nav">
      ...
      <li class="nav-item" @click="handlerNav('message')">
      ...
      <li class="nav-item" @click="handlerNav('find')">
...
export default {
  ...
  computed: {
    ...mapGetters(["navActivate", "userInfo"])
  },
  watch: {},
  created() {
  },
  ...
  methods: {
    // 切换左侧菜单导航
    handlerNav(navActivate) {
      this.$store.dispatch("common/setNavActivate", navActivate);
    },
    /* 修改头像相关事件 */
    // 上传头像事件
...
.image-cropper-dialog {
  ...
  /* 圆形裁剪框 */
  ::v-deep .image-cropper-circular .cropper-view-box {
    /*   将裁剪框由方形调整为圆形 */
    border-radius: 50%;
  }
